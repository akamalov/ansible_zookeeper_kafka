...
Please download [kafka_2.12-0.10.2.0.tgz](http://www.gtlib.gatech.edu/pub/apache/kafka/0.10.2.0/kafka_2.12-0.10.2.0.tgz) and store it in `file_archives` directory.**
